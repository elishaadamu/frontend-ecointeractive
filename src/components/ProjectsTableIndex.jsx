...
const ProjectsTable = ({ geoData, selectedProjectType, selectedYearProgrammed, selectedFundingSource }) => {
  ...
  const filteredProjects = projects.filter((project) => {
    ...
    return projectTypeMatch && yearProgrammedMatch && fundingSourceMatch;
  });
